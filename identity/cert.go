...
func sanitizeECDSASignedCert(cert *x509.Certificate, parentCert *x509.Certificate) (*x509.Certificate, error) {
	...
	expectedSig, err := util.SignatureToLowS(parentCert.PublicKey.(*ecdsa.PublicKey), cert.Signature)
	if err != nil {
		return nil, err
	}
...
func certFromX509Cert(cert *x509.Certificate) (certificate, error) {
	...
	if err != nil {
		return certificate{}, errors.Wrap(err, "Unmarshaling of the certificate failed")
	}
	return newCert, nil
}
